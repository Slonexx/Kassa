...
@section('content')
    ...
    <div class="content p-4 mt-2 bg-white text-Black rounded" style="font-size: 14px">
        <div class="row gradient rounded p-2 pb-2" style="margin-top: -1rem">
            <div class="col-9" style="margin-top: 1.0rem"> <span id="HEAD_TOP_SERVICE" class="text-white" style="font-size: 20px">Возможности интеграции</span> </div>
            <div class="col-3 text-center">
                <img src="https://rekassa/logoHeadWhite.png" alt="" width="100%">
            </div>
        </div>
        <script>
